...
| --- | -------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------- | ----------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| 1   | Standardized Precipitation Index (SPI) | Open    | Drought index that captures how observed precipitation deviates from the climatological average over a given time period. | Monthly           | [drought.gov](https://www.drought.gov/data-maps-tools/global-gridded-standardized-precipitation-index-spi-cmorph-daily) | Benny Istanto (bistanto@worldbank.org)           |
| 2   | GADM Administrative Boundaries         | Open    | Geosptaial administrative boundary data                                                                                   | Varies by country | Via [Website](https://gadm.org/) and Project SharePoint                                                                 | Andres Chamorro (achamorroelizond@worldbank.org) |
| 3   |                                        |         |                                                                                                                           |                   |                                                                                                                         |                                                  |
| 4   |                                        |         |                                                                                                                           |                   |                                                                                                                         |                                                  |
| 5   |                                        |         |                                                                                                                           |                   |                                                                                                                         |                                                  |
| 6   |                                        |         |                                                                                                                           |                   |                                                                                                                         |                                                  |
...
| --- | ------------------ | --------------------------------------------- | ------------- | -------------------------------- |
| A   | Drought Monitoring | Observed droughts in Morocco from *xx* to yy. | *forthcoming* | 1,2                              |
| B   |                    |                                               |               |                                  |
| C   |                    |                                               |               |                                  |
